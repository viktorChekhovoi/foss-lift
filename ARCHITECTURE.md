...
The thirteen programs the app ships — two hypertrophy splits (PPL, Upper/Lower),
three beginner strength routines (Starting Strength, StrongLifts 5x5, Full Body
3x), four that ask for less than a gym, and four 5/3/1 templates — as a table of
prescriptions in code rather than rows in the database. Each

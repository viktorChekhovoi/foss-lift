...
- **A new persisted field/table** → edit `data/database.dart`, rerun
  ...
  The ladder currently runs **v1 → v2 → v3 → v4 → v5 → v6 → v7 → v8 → v9**
  ...
  `WorkoutItems.add_weight_at_top_of_range`). The starter walk

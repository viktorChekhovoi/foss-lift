...
String equipmentLabel(AppLocalizations l10n, String stored) => switch (stored) {
...
String? _seeded(AppLocalizations l10n, String key) => switch (key) {
  ...
  'paused_bench_press' => l10n.exercisePausedBenchPress,
  'pause_squat' => l10n.exercisePauseSquat,
  'pause_deadlift' => l10n.exercisePauseDeadlift,
  'deadlift_to_knees' => l10n.exerciseDeadliftToKnees,
  'block_deadlift' => l10n.exerciseBlockDeadlift,
  'deficit_deadlift' => l10n.exerciseDeficitDeadlift,
  ...
  'seated_good_morning' => l10n.exerciseSeatedGoodMorning,
  ...
  'french_press' => l10n.exerciseFrenchPress,
  ...
  'gzclp' => l10n.seedRoutineGzclp,
  'push_pull_legs' => l10n.seedRoutinePushPullLegs,
  'ppl_6_day' => l10n.seedRoutinePpl,
  'fitness_basic_beginner' => l10n.seedRoutineFitnessBasicBeginner,
  'bodyweightfitness_recommended' =>
    l10n.seedRoutineBodyweightfitnessRecommended,
  'dumbbell_stopgap' => l10n.seedRoutineDumbbellStopgap,
  ...
  'five_three_one_classic' => l10n.seedRoutine531Classic,
  'five_three_one_bbb' => l10n.seedRoutine531BoringButBig,
  'five_three_one_fsl' => l10n.seedRoutine531FirstSetLast,
  'five_three_one_beginners' => l10n.seedRoutine531Beginners,
  'candito_linear_control' => l10n.seedRoutineCanditoControl,
  'candito_linear_hypertrophy' => l10n.seedRoutineCanditoHypertrophy,
  'sheiko_29_32' => l10n.seedRoutineSheiko2932,
  'tsa_beginner' => l10n.seedRoutineTsaBeginner,
  'tsa_intermediate_2' => l10n.seedRoutineTsaIntermediate2,
  'pull_a' => l10n.seedDayPullA,
  'push_a' => l10n.seedDayPushA,
  'legs_a' => l10n.seedDayLegsA,
  'pull_b' => l10n.seedDayPullB,
  'push_b' => l10n.seedDayPushB,
  'legs_b' => l10n.seedDayLegsB,
  ...
  'press' => l10n.seedDayPress,
  'deadlift_day' => l10n.seedDayDeadlift,
  'bench' => l10n.seedDayBench,
  'squat' => l10n.seedDaySquat,
  'heavy_lower' => l10n.seedDayHeavyLower,
  'heavy_upper' => l10n.seedDayHeavyUpper,
  'control_lower' => l10n.seedDayControlLower,
  'control_upper' => l10n.seedDayControlUpper,
  'variation_lower' => l10n.seedDayVariationLower,
  'variation_upper' => l10n.seedDayVariationUpper,
...
String? _seededDescription(AppLocalizations l10n, String key) => switch (key) {
  'gzclp' => l10n.seedRoutineDescGzclp,
  'push_pull_legs' => l10n.seedRoutineDescPushPullLegs,
  'ppl_6_day' => l10n.seedRoutineDescPpl,
  'fitness_basic_beginner' => l10n.seedRoutineDescFitnessBasicBeginner,
  'bodyweightfitness_recommended' =>
    l10n.seedRoutineDescBodyweightfitnessRecommended,
  'dumbbell_stopgap' => l10n.seedRoutineDescDumbbellStopgap,
  ...
  'five_three_one_classic' => l10n.seedRoutineDesc531Classic,
  'five_three_one_bbb' => l10n.seedRoutineDesc531BoringButBig,
  'five_three_one_fsl' => l10n.seedRoutineDesc531FirstSetLast,
  'five_three_one_beginners' => l10n.seedRoutineDesc531Beginners,
  'candito_linear_control' => l10n.seedRoutineDescCanditoControl,
  'candito_linear_hypertrophy' => l10n.seedRoutineDescCanditoHypertrophy,
  'sheiko_29_32' => l10n.seedRoutineDescSheiko2932,
  'tsa_beginner' => l10n.seedRoutineDescTsaBeginner,
  'tsa_intermediate_2' => l10n.seedRoutineDescTsaIntermediate2,
  _ => null,
};
